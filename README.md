...
> **70 reproduced attack techniques blocked, and counting.** Each was
...
> webhooks, IPFS — the worm’s Ethereum-transaction C2), recursive `cp`/`rename`
> that planted persistence past every check,
